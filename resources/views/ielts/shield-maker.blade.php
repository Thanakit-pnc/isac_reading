    ...
    <div class="row mt-1">
        ...
        <div class="col-md-6">
            <div class="card-box font-16 text-dark overflow-custom">
                ...
                <p class="mt-0 mb-1">For Questions 6 to 10 select the letters A – K.</p>
                        ...
                        <table class="table table-bordered table-sm text-dark">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle">Designs used to decorate the coffins of important people.</td>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">The possibility of this art form being continued into the future.</td>
                                    <td class="position-relative"> 
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">His father’s and grandfather’s occupations.</td>
                                    <td class="position-relative">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">Examples of when dragon motifs can be safely used.</td>
                                    <td class="position-relative">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">Details of Jenggi’s personality.</td>
                                    <td class="position-relative">
                ...
                <p class="mt-0 mb-1">Complete the following passage using words from the box. </p>
