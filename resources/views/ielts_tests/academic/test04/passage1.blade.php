...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>One superstition associated with the Koh-I-Noor diamond is</label>
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>Why do you think diamonds are so expensive to buy?</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>Not all diamonds are suited for use as jewellery because</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>Why was the carob seed chosen as a unit of weight for the diamond?</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>What may cause the gem to fragment into thousands of pieces?</label>
        <div class="custom-control custom-radio">
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>6. The benefits of using modern technology in shaping diamonds.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>7. A large amount of raw material is needed to produce a diamond.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>8. An example of a famous diamond.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>9. A formal attempt to set standards in diamond quality.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>10. Examples of places where diamonds can be found underground.</label>
...
<div class="d-inline-block mt-3" style="line-height: 3.4;">
    A ‘carat’ was exactly the same weight as
    <label>11</label>
    <input type="text" class="form-control w-auto d-inline-block" name="q11">
    and was used as a standard measure until the introduction of 
    <label>12</label>
    <input type="text" class="form-control w-auto d-inline-block" name="q12">
    in the twentieth century. Currently, the carat is the unit of measurement of weight for all gems with the exception of
    <label>13</label>
    <input type="text" class="form-control w-auto d-inline-block" name="q13"> .
    Each carat is sub-divided into smaller measurements known as 
    <label>14</label>
    <input type="text" class="form-control w-auto d-inline-block" name="q14">
</div>