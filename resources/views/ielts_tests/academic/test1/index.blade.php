                    ...
                    <div class="tab-content b-0 font-16 text-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test1.passage1')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="passage2">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <span class="font-weight-bold">Questions 15 - 27</span>, which are based on Reading Passage 2.
                                    </p>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test1.passage2')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="passage3">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test1.passage3')
                                    </div>
                                </div>
                            </div>
                        </div>
