                    ...
                    <div class="tab-content b-0 font-16 text-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test5.passage1') 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="passage2">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test5.passage2')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="passage3">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.academic.test5.passage3')
                                    </div>
                                </div>
                            </div>
                        </div>
