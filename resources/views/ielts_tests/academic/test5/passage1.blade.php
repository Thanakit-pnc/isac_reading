...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>Why don’t many people walk around in Dubai?</label>
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>What is referred to as the “rhythms of old Arabia”?</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>How are the “wind-tower” houses cooled?</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>What do we know about the Majlis Gallery? </label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>Which of the following was not a raw material for increasing Dubai’s economic status?</label>
        <div class="custom-control custom-radio">
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>6. The preferred metal for Bedouin jewellery.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>7. An impression of the Dubai sky-line when arriving by boat.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>8. A comparison of occupations between city and countryside folk.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>9. Why houses in Dubai have a slightly orange appearance.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>10. Different rooms for welcoming men and women into the home.</label>
