...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>What do we know about the hotel mentioned in the first paragraph?</label>
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>The first function of comic strip was</label>
        <div class="custom-control custom-radio">
...
<div class="mt-1 d-flex">
    ...
    <div>
        <label>The ‘Yellow Kid’ of 1895 was different from modern comic strips because</label>
        <div class="custom-control custom-radio">
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>6. Where to purchase a school bag with a picture of Tintin’s pet dog.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>7. The development of comic strips as part of the school curriculum. </label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>8. An unusual place to stay.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>9. Large paintings on city walls.</label>
...
<div class="d-flex justify-content-between align-items-center mt-2">
    <label>10. Another name for the comic strip.</label>
...
<div class="d-inline-block mt-3" style="line-height: 1.8;">
    Along a ‘Comic Strip Route’ established by the Brussels Tourist Board, wanderers can meet some of Belgium’s most
    <label>11.</label> 
    ...
    strips also enliven three of Brussels’ underground stations.  In the Stockel underground, two 135 metre long friezes
    <label>13.</label> 
    ...
    140 characters of Herge’s comic strips
    <label>14.</label> 
