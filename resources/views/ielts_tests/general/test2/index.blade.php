                    ...
                    <div class="tab-content b-0 font-14 text-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.general.test2.passage1')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="section2">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.general.test2.passage2')
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane" id="section3">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-box height">
                                        @include('ielts_tests.general.test2.passage3')
                                    </div>
                                </div>
                            </div>
                        </div>
